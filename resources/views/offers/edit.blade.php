...
<h1>{{__('messeg.edit your offer')}}</h1>
...
<form method="POST" action="{{route('offers.update', $offer -> id)}}">
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" name="name_ar" value="{{$offer -> name_ar}}" aria-describedby="emailHelp" placeholder="Enter email">
        @error('name_ar')
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" name="name_en" value="{{$offer -> name_en}}" aria-describedby="emailHelp" placeholder="Enter email">
        @error('name_en')
        <small class="form-text text-danger" >{{$message}}</small>
        @enderror
    </div>
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" name="details_ar" value="{{$offer -> details_ar}}" placeholder="details">
        @error('details_ar')
        <small class="form-text text-danger" >{{$message}}</small>
        @enderror
    </div>
    <div class="form-group">
        ...
        <input type="text" class="form-control" name="details_en" value="{{$offer -> details_en}}"  placeholder="details">
        @error('details_en')
        <small class="form-text text-danger" >{{$message}}</small>
        @enderror
    </div>
